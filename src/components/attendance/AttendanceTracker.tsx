        ...
        <TabsContent value="checkin" className="space-y-4">
          <Card>
            ...
            <CardContent className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <Button variant="outline" className="h-32 flex-col gap-2 hover:border-primary hover:bg-primary/5" onClick={() => handleCheckIn("QR Code")}>
                <QrCode className="h-8 w-8 text-primary" />
                <span>QR Code</span>
              </Button>
              
              <Button variant="outline" className="h-32 flex-col gap-2 hover:border-secondary hover:bg-secondary/5" onClick={() => handleCheckIn("Wi-Fi Proximity")}>
                <Wifi className="h-8 w-8 text-secondary" />
                <span>Wi-Fi Proximity</span>
              </Button>
              
              <Button variant="outline" className="h-32 flex-col gap-2 hover:border-accent hover:bg-accent/5" onClick={() => handleCheckIn("Facial Recognition")}>
